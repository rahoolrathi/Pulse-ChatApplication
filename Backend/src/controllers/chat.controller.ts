...
static async getPrivateMessages(req: AuthenticatedRequest, res: Response) {
    try {
      ...
      const result = await ChatService.getPrivateMessages(currentUserId, otherUserId, page, limit);
...
static async getPrivateChatBoxListController(req: AuthenticatedRequest, res: Response) {
    try {
      const currentUserId = req.userId;
...
static async getGroupChatBoxListController(req: AuthenticatedRequest, res: Response) {
    try {
      const currentUserId = req.userId;
